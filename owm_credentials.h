...
String Lat				= "xx.xx";
String Lon 				= "-yyy.yyy";
String City 			= "City   ";                       // Your home city See: http://bulk.openweathermap.org/sample/
...
String Units            = "imperial";                      // Use 'M' for Metric or I for Imperial
const char* Timezone    = "MST7"; 						   // Choose your time zone from: https://github.com/nayarsystems/posix_tz_db/blob/master/zones.csv
